...
class ContractBreachScraper:
    ...
    def _extract_descriptors(self, text):
        ...
        exclude_patterns = [
            r'data\s+da\s+senten[çc]a', r'processo:', r'ju[ií]z:',
            r'tribunal:', r'decisão:', r'área:', r'^[0-9\s\-/]+$'
        ]
    ...
    def _validate_and_extract(self, full_text, search_start, match, verb_pattern, 
                             method_name, confidence, require_verbs=False):
        """
